    ...
    >
      {data_skeleton_two.map((data, i) => (
        <motion.div
          ...
          className="flex flex-row rounded-full border border-white/[0.2] p-3 text-xs  items-center space-x-2 bg-black w-full h-4"
        >
          {data}
        </motion.div>
      ))}
...
const items = [
  ...
  {
    title: "My teck Stack",
    description: <span className="text-sm">I constantly try to improve.</span>,
    header: <SkeletonTwo />,
    className: "md:col-span-1",
